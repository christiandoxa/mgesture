...
comptime SCROLL_ENTRY_REACH = Float64(0.85)
comptime SCROLL_ACTIVE_REACH = Float64(0.77)
...
struct GestureEngine(Copyable, Movable, Writable):
    ...
    def measure(self, landmarks: Pointer[mut=True, Float32, MutAnyOrigin]) -> Measurements:
        ...
        var scroll_pinch_clear = index_pinch > self.config.pinch_down_threshold and middle_pinch > self.config.pinch_down_threshold
